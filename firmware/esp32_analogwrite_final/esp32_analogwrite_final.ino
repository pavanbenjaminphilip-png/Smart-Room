...
// Light thresholds for blinds (300 lumen target)
#define LIGHT_THRESHOLD_BRIGHT 320   // If light > this, OPEN blinds
#define LIGHT_THRESHOLD_DIM 280      // If light < this, CLOSE blinds
